...
import crudapps.NoSuchFooException;

import crudapps.model.Foo;

import crudapps.model.impl.FooImpl;
import crudapps.model.impl.FooModelImpl;

import crudapps.service.persistence.FooPersistence;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
    ...
    @Override
    public Foo updateImpl(crudapps.model.Foo foo, boolean merge)
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.crudapps.model.Foo")));
