...
public class FooLocalServiceUtil {
	 ...
	 */
	public static service.model.Foo addFoo(service.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static service.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static service.model.Foo deleteFoo(service.model.Foo foo) {
	 ...
	 */
	public static service.model.Foo deleteFoo(long fooId)
	...
	public static service.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static service.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static service.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static service.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<service.model.Foo> getFoos(
		int start, int end) {
	 ...
	 */
	public static java.util.List<service.model.Foo> getFoosByUuidAndCompanyId(
	 ...
	 */
	public static service.model.Foo updateFoo(service.model.Foo foo) {
