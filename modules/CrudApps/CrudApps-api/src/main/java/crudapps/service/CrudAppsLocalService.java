...
/**
 * Provides the local service interface for CrudApps. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CrudAppsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CrudAppsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>crudapps.service.impl.CrudAppsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the crud apps local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CrudAppsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CrudApps addCrudApps(CrudApps crudApps);
	...
	public CrudApps createCrudApps(long appId);
	...
	public CrudApps deleteCrudApps(CrudApps crudApps);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CrudApps deleteCrudApps(long appId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrudApps fetchCrudApps(long appId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrudApps getCrudApps(long appId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrudApps> getCrudAppses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CrudApps updateCrudApps(CrudApps crudApps);
